...
import com.filipelins.cursomc.dto.ProdutoDTO;
import com.filipelins.cursomc.resources.utils.URL;
import com.filipelins.cursomc.services.ProdutoService;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(@RequestParam(value = "nome", defaultValue = "") String nome,
		...
		Page<ProdutoDTO> list = produtos.map(obj -> new ProdutoDTO(obj));
