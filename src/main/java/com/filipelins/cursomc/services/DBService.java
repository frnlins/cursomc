...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente("Joaquim Silva", "frnlins@bol.com.br", "36378912377", TipoCliente.PESSOAFISICA,
				bCryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente("Gabriela Cravo", "frnlins@yahoo.com.br", "58471154072", TipoCliente.PESSOAFISICA,
				bCryptPasswordEncoder.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("33232736", "83939383"));
		...
		Endereco e3 = new Endereco("Av. ACM", "1500", "apto 200", "Boca do Rio", "40000001", cli2, cit1);
