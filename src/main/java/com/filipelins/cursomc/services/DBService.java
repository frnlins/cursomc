...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente("Joaquim Silva", "teste1@mail.com", "36378912377", TipoCliente.PESSOAFISICA,
				bCryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente("Gabriela Cravo", "teste2@mail.com", "58471154072", TipoCliente.PESSOAFISICA,
				bCryptPasswordEncoder.encode("123"));
